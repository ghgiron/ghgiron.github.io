...
/////////////////////////////////////////////////////////////////
    ...
    //with custom pager
    if ($('.bxslider-pager-wrap').length > 0) {

        $('.bxslider-pager-wrap').bxSlider({
...
/////////////////////////////////////////////////////////////////
    ...
    if ($('.b-home-slider').length > 0) {
        $('.b-home-slider').not('.slick-initialized').slick({
    ...
    if ($('.b-latest-carousel').length > 0) {
        ...
        $('.b-latest-carousel').not('.slick-initialized').slick({
            variableWidth: true,
            centerMode: true,
            centerPadding: '80px',
            slidesToShow: 1,
